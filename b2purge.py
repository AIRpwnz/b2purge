...
def main():
    ...
    parser.add_argument('folder_path', type=str, help='Path to the folder in the B2 bucket')
    parser.add_argument('days', type=int, help='Number of days old the files should be to be deleted')
